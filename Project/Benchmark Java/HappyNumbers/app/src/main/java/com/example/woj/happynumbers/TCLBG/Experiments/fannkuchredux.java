...
http://benchmarksgame.alioth.debian.org/u64/program.php?test=fannkuchredux&lang=java&id=1
 *
...
public final class fannkuchredux implements Runnable
{
    ...
    void runTask( int task )
    {
        ...
        int idxMax = Math.min( Fact[DEFAULT_NUMBER], idxMin+CHUNKSZ );
    ...
    public void run()
    {
        p     = new int[DEFAULT_NUMBER];
        pp    = new int[DEFAULT_NUMBER];
        count = new int[DEFAULT_NUMBER];
