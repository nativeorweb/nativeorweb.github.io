...
The Computer Language Benchmarks Game
 http://benchmarksgame.alioth.debian.org/
http://benchmarksgame.alioth.debian.org/u64q/program.php?test=knucleotide&lang=java&id=7
...
public class knucleotide {
    ...
    public static void execute(String fileName, Context context) throws Exception {
