...
//        {
            ...
            String hino = Util.GIANTSTRING;

            inputView.setText(hino);

            String message = inputView.getText().toString(); //MODIFICADO PARA UM ENTRADA PADRÃO!

            message = inputPreparer.prepareString(message);
            input.setText(message);
            getEnigma().encryptString(message);
